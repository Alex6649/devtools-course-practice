...
//    MassConverter conv;
//    // Assert
//    ASSERT_ANY_THROW(conv.unciaToStoun(uncia));
//}
...
//    MassConverter conv;
//    // Assert
//    EXPECT_DOUBLE_EQ(conv.unciaToKilogramm(uncia), res);
//}
//TEST(Mass_Converter, Throw_with_Transform_Uncia_To_Kilogramm) {
//    // Arrange
//    double uncia = -598;
//    // Act
//    MassConverter conv;
//    // Assert
//    ASSERT_ANY_THROW(conv.unciaToKilogramm(uncia));
//}
